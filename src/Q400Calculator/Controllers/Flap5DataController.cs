...
{
    public class Flap5DataController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Flap5DataController(ApplicationDbContext context)
        {
            _context = context;    
        }
        ...
        {
            return View(await _context.Flap5Data.ToListAsync());
        }

        // GET: Flap5Data/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var flapData = await _context.Flap5Data.SingleOrDefaultAsync(m => m.Id == id);
            if (flapData == null)
            {
                return NotFound();
            }
        ...
        // GET: Flap5Data/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Flap5Data/Create
        ...
        // POST: Flap5Data/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            var flapData = await _context.Flap5Data.SingleOrDefaultAsync(m => m.Id == id);
            _context.Flap5Data.Remove(flapData);
            await _context.SaveChangesAsync();
            return RedirectToAction("Index");
        }
        ...
        {
            return _context.Flap5Data.Any(e => e.Id == id);
        }
    }
}
